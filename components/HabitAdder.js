...
function HabitAdder({ setAddingHabit, setAddingStack }) {
    return (
        <View>
            ...
            <TextInput style={styles.inputSimpleBorder} size={30} placeholder="Habit Name"/>
            <TextInput style={styles.inputSimpleBorder} size={30} placeholder="Stack To Add Habit To"/>
        </View>
    );
}
